...
public class AuthController {
    ...
    @Autowired
    public AuthController(UserService userService, EventService eventService, VenueService venueService, SessionService sessionService) {
